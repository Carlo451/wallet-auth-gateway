...
public class DcqlCredentialMetaVctValues implements IDcqlCredentialMeta{

    @JsonProperty("vct_values")
    private List<String> vctValues;

    public DcqlCredentialMetaVctValues() {
    }

    public DcqlCredentialMetaVctValues(List<String> vctValues) {
